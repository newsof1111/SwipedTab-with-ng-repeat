        ...
        link: function (scope, element, attrs, parent) {
            ...
            var init = function () {
                ...
                if (options.slideTabsScrollable) {
                    ...
                    tabsBar = angular.element('<ion-scroll has-bouncing="false" style="    overflow-x:hidden;" overflow-scroll="false"  delegate-handle="' + ionicScrollDelegateID + '" class="slidingTabs" direction="x" ><ul>' + tabItems + '</ul> <div class="tab-indicator-wrapper"><div class="tab-indicator"></div></div> </ion-scroll>');
                }
                else {
